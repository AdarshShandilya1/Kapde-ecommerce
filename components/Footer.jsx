export default function Footer(){
    return(
        <>
            <div className="grid grid-cols-2 md:grid-cols-4 p-14 bg-gray-50 gap-6">
            ...
            <div  className="text-center px-10 pb-10 text-sm bg-gray-50">KAPDE ESSENTIALS PRIVATE LIMITED © 2023</div>
